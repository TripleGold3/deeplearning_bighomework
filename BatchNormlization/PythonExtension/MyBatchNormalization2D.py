...
class MyBatchNormalization2dFunction(Function):
    ...
    def backward(ctx, grad_output):
        ...
        return None, grad_X, None, None, grad_gamma, grad_beta, None, None, None 
...
class MyBatchNormalization2d(nn.Module):
    ...
    def forward(self, X):
        output =  MyBatchNormalization2dFunction.apply(self if self.training else None, X, self.training, self.epsilon, self.gamma, self.beta, self.momentum, self.moving_mean, self.moving_var)
